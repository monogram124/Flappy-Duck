...
let column4 = new Column(img3, 1200, getRandomInRange(600, 750), -10, 150, 530);
    ...
    if(player.y > cnv.height - 40){
        ...
        document.addEventListener('keydown', function(evt){
            if(evt.keyCode === 82){
                ...
                player.y += player.velocity;
                player.velocity += player.acceleration;
                restartFunc(column, 650, getRandomInRange(-200, -150), -10, 150, 480);
                restartFunc(column2, 650, getRandomInRange(600, 750), -10, 150, 530);
                restartFunc(column3, 1200, getRandomInRange(-200, -150), -10, 150, 480);
                restartFunc(column4, 1200, getRandomInRange(600, 750), -10, 150, 530);
